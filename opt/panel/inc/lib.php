...
");
	...
	// Copy spigot
	if ($_POST['version'] == '1.15.2') {
		copy('serverbase/paper-1.15.2-latest.jar',$_POST['dir'].'/paper-1.15.2-latest.jar');
	} else if ($_POST['version'] == '1.16.1') {
		copy('serverbase/paper-1.16.1-latest.jar',$_POST['dir'].'/paper-1.16.1-latest.jar');
